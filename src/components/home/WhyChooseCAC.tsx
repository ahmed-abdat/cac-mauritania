            ...
            return (
              ...
              >
                <div className="relative">
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gray-50 mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
                    <IconComponent
            ...
            return (
              ...
              >
                ...
                <div className="mb-4 relative z-10 px-10 text-neutral-600 dark:text-neutral-400">
                  <div
                    className={`w-12 h-12 rounded-2xl flex items-center justify-center bg-gradient-to-br ${
                      advantage.gradientFrom || "from-primary"
                    } ${
                      advantage.gradientTo || "to-blue-600"
                    } shadow-sm group-hover/feature:shadow-md group-hover/feature:scale-110 transition-all duration-300`}
                  >
                    <IconComponent
                ...
                <div className="text-lg font-bold mb-2 relative z-10 px-10">
                  <div
                    className={`absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-neutral-300 dark:bg-neutral-700 group-hover/feature:bg-gradient-to-b ${
                      advantage.gradientFrom ||
                      "group-hover/feature:from-primary"
                    } ${
                      advantage.gradientTo || "group-hover/feature:to-blue-600"
                ...
                <div className="space-y-2 relative z-10 px-10">
                  {advantage.features
                    ...
                    .map((feature, featureIndex) => (
                      ...
                      >
                        <CheckCircle
                          className={`w-3 h-3 ${advantage.iconColor}`}
                        />
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6 text-center">
              {[
                ...
                return (
                  ...
                  >
                    <div
                      className={`relative mx-auto flex aspect-square size-16 rounded-2xl border before:absolute before:-inset-2 before:rounded-2xl before:border dark:border-white/10 dark:before:border-white/5 ${value.bg} group-hover:shadow-lg transition-all duration-300`}
                    >
                      <IconComponent
                        className={`m-auto size-7 ${value.color} group-hover:scale-110 transition-transform duration-300`}
                        strokeWidth={1.5}
                      />
                    </div>
